...
export default function RecommendationCard({
  ...
  // Debug: Log confidence prop value
  console.log('RecommendationCard confidence prop:', confidence);
        ...
        <CardContent className="p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="text-right">
              <div className={`text-4xl font-bold ${config.textColor}`}>{(confidence * 100).toFixed(0)}%</div>
